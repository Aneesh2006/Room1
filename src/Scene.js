...
export function Scene(props) {
  ...
  // Get the priced item
  const price = { KITCHEN: 5999, CARPET: 433, LAMP: 77, CHAIR: 255, TABLE: 1699, POT: 44 }[hovered] ?? 5999
  return (
    <>
      <group {...props}>
        ...
        <Select enabled={hovered === "CHAIR"} onPointerOver={over("CHAIR")} onPointerOut={() => debouncedHover(null)}>
        ...
        <Select enabled={hovered === "FLOWER POT"} onPointerOver={over("FLOWER POT")} onPointerOut={() => debouncedHover(null)}>
          <mesh geometry={nodes.vase.geometry} material={materials.gray} material-envMap={env} />
        </Select>
        <Select enabled={hovered === "LAMP"} onPointerOver={over("LAMP")} onPointerOut={() => debouncedHover(null)}>
